...
public class SkyEffectMaterial extends ANeonPathMaterial {
	...
	protected static final String mVShader = 
		...
		protected static final String mFShader = 
			...
			"void main() {\n" +
			"   float gradientColor = texture2D(uDiffuseTexture, vTextureCoord).g*texture2D(uDiffuseTexture, vTextureCoordTime).g*1.4;\n" +
			"	vec3 color = pathColor*gradientColor;\n" +
			"   gl_FragColor = vec4(color.x, color.y, color.z, 1.0);\n" + 
			"}\n";
		
	public SkyEffectMaterial(int skyColor) {
